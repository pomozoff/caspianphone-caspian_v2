...
// Added by ankit khanna on 7 March to remove warnings
...
- (IBAction)onBackClick: (id) event {
    NSLog(@"Activate SMS");
    // Commented by ankit khanna on 8 March for SMS Change  [[PhoneMainView instance] changeCurrentView:[InCallViewController compositeViewDescription]];
}
...
// Added by ankit khanna on 9 March 2015 for SMS View Controller Segue

// End

// Added by ankit khanna on 4 March 2015 for Activate SMS scene
