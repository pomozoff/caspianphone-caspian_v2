...
//                        NSString *phoneObj1 = [NSString stringWithFormat:@"%@",[dataCache objectAtIndex:0]];
...
//            int buttonTagConstantChat = 500;
//            
//            // Before creating the buttons, delete the old ones first.
//            for (UIView* subV in self.view.subviews)
//            {
//                if ([subV isKindOfClass:[UIButton class]] && subV.tag >= buttonTagConstantChat)
//                {
//                    [subV removeFromSuperview];
//                }
//            }
...
//                btn1.frame = CGRectMake(260, 115, 32, 25); //The position and size of the button (x,y,width,height)
//                //    [btn setTitle:@"SMS" forState:UIControlStateNormal];
//                UIImage * buttonImage = [UIImage imageNamed:@"Message-50.png"];
//                [btn1 setBackgroundImage:buttonImage forState:UIControlStateNormal];
//                [btn1 addTarget:self action:@selector(showAbout:) forControlEvents:(UIControlEvents)UIControlEventTouchUpInside];
//                btn1.tag = buttonTagConstantChat;
//                [self.view addSubview:btn1];
//            }
//            
//            int y_of_the_button_chat = 115;
//            NSLog(@"ABMultiValueGetCount(lMap):%ld",ABMultiValueGetCount(lMap));
//            for (int i=0;i<ABMultiValueGetCount(lMap);i++)
//            {
//                UIButton *btn1 = [UIButton buttonWithType:UIButtonTypeRoundedRect];
//                btn1.frame = CGRectMake(260, y_of_the_button_chat, 32, 25); //The position and size of the button (x,y,width,height)
//                // [btn setTitle:@"SMS" forState:UIControlStateNormal];
//                UIImage * buttonImage1 = [UIImage imageNamed:@"Message-50.png"];
//                [btn1 setBackgroundImage:buttonImage1 forState:UIControlStateNormal];
//                [btn1 addTarget:self action:@selector(showAbout:) forControlEvents:(UIControlEvents)UIControlEventTouchUpInside];
//                btn1.tag = buttonTagConstantChat+i;
//                NSLog(@"buttonTagConstantChat:%d",btn1.tag);
//                [self.view addSubview:btn1];
//                y_of_the_button += 45;
//            }
//            
